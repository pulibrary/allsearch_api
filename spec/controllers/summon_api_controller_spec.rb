...
RSpec.describe SummonApiController do
  it 'sanitizes input' do
    stub_summon(query: 'bad%20bin%20bash%20script', fixture: 'summon_api/bash.json')
  ...
  it 'removes redundant space from query' do
    stub_summon(query: 'war%20and%20peace', fixture: 'summon_api/war_and_peace.json')
