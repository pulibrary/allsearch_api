  ...
  describe '#more_link' do
    ...
    context 'when on a non-production environment' do
      before do
        ...
        stub_request(:get, 'http://lib-solr8-staging.princeton.edu:8983/solr/catalog-staging/select?facet=false&fl=id,title_display,author_display,pub_created_display,format,holdings_1display,electronic_portfolio_s,electronic_access_1display&q=rubix&rows=3&sort=score%20desc,%20pub_date_start_sort%20desc,%20title_sort%20asc')
